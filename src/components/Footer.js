...
const Footer = () => {
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-conten mt-5">
            <div className="items-center grid-flow-col text-gray-500">
                ...
                <p>Copyright © 2024 - All right reserved || Sharif Hasan</p>
            </div>
